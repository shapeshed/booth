...
class StreamingPodcastFeedProvider(
    ...
    suspend fun fetch(feedUrl: String, onUpdate: suspend (PodcastFeed) -> Unit): PodcastFeed =
                ...
                client.newCall(
                    ...
                    if (!response.isSuccessful) {
                        ...
                        try {
                            ...
                            failure =
                                FeedParseEvent.Failed(
                                    FailureCategory.UNKNOWN,
                                    RuntimeException("Streaming discovery parser failed"),
                                )
                        }
