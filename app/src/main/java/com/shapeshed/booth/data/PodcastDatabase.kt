...
@Database(entities = [PodcastEntity::class, EpisodeEntity::class, EpisodeSearchFtsEntity::class, QueueEntity::class, DownloadAssetEntity::class, DirectoryProviderEntity::class, CategoryEntity::class, CategoryPodcastEntity::class], version = 26, exportSchema = true)
