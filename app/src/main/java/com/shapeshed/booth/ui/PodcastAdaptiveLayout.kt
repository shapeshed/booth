...
internal data class PodcastAdaptiveLayout(val useNavigationRail: Boolean, val useTwoPaneEpisodeLayout: Boolean)

/** Keeps product layout decisions separate from WindowSizeClass and therefore unit-testable. */
internal fun podcastAdaptiveLayout(isWidthAtLeastBreakpoint: (Int) -> Boolean): PodcastAdaptiveLayout =
    PodcastAdaptiveLayout(
