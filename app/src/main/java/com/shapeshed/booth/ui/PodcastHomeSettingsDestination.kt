...
internal fun PodcastHomeSettingsDestination(
    ...
    PodcastAppSettingsContent(
        ...
        onDownloadLimitChange = viewModel::setPodcastDownloadLimit,
        deleteBeforeAutoDownload = homeUiState.settings.deleteBeforeAutoDownload,
        onDeleteBeforeAutoDownloadChange = viewModel::setPodcastDeleteBeforeAutoDownload,
        removePlayedDownloads = homeUiState.settings.removePlayedDownloads,
        onRemovePlayedDownloadsChange = viewModel::setPodcastRemovePlayedDownloads,
